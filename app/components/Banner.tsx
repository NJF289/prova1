    export default function Banner() {
        return (
            <div className="flex flex-col-reverse mt-4 border-t-4 border-[#F56A6A] grid-cols-2 md:grid">
                ...
                <div className="w-full h-auto mt-14 dl-3"><img src="/img/pic10.png" alt="" /></div>
            </div>
