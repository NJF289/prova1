export default function Content() {
    return (
        <div className="mt-10 border-t-4 border-[#D2D7D9] ">
            ...
            <p className="mt-3 border-t-4 border-[#F56A6A] max-w-28"></p>
            <div className=" grid-cols-2 md:grid md:mt-12">
            
            <div className="text-justify mt-8 grid-cols-5 md:grid lg:grid-cols-3 ">
                <div className="col-span-2 max-w-28 place-self-end mr-7 lg:col-span-1 "> <img src="/img/spannn.png" alt="" /></div>
                ...
                <div className="text-justify mt-8 grid-cols-5 md:grid lg:grid-cols-3 ">
                <div className="col-span-2 max-w-28 place-self-end md:mr-7 lg:col-span-1"> <img src="/img/span1.png" alt="" /></div>
                <div className="col-span-3 lg:col-span-2">
                ...
                <div className="text-justify mt-8 grid-cols-5 md:grid lg:grid-cols-3">
                <div className="col-span-2 max-w-28 place-self-end md:mr-7 lg:col-span-1"> <img src="/img/span2.png" alt="" /></div>
                <div className="col-span-3 lg:col-span-2">
