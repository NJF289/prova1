export default function Content() {
    return (
        <div className="mt-10 border-t-4 border-[#D2D7D9] ">
            ...
            <div className=" grid-cols-2 md:grid md:mt-16">
            
            <div className="text-justify mt-8 grid-cols-3 md:grid">
                <div className="max-w-28 place-self-end mr-7 "> <img src="/img/spannn.png" alt="" /></div>
                ...
                <div className="text-justify mt-8 mr-4 grid-cols-3 md:grid">
